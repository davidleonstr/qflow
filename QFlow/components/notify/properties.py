...
ICONS = {
    'success': lambda: Icon('QFlow/components/notify/icons/check.png', 25, 25),
    'error': lambda: Icon('QFlow/components/notify/icons/close.png', 25, 25),
    'info': lambda: Icon('QFlow/components/notify/icons/information.png', 25, 25),
}
"""
